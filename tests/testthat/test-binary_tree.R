...
test_that("children assignment",	{
			...
			testthat::expect_false(is_leaf(node1))
			testthat::expect_false(is_leaf(node3))
			testthat::expect_true(is_leaf(node2))
			testthat::expect_true(is_leaf(node4))
			testthat::expect_true(is_leaf(node5))
			testthat::expect_true(is_leaf(node6))
			testthat::expect_equal(get_depth(tree),		3L)
			testthat::expect_equal(count_leaves(tree),	4L)
})
